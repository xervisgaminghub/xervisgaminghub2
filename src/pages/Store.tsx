...
import { ShoppingCart, Diamond, ShieldCheck, CreditCard, Send, Folder, Download, Search, Trophy, Gamepad2, Activity, Megaphone, Info, AlertTriangle, Star, CheckCircle, ChevronRight, ChevronLeft, X } from 'lucide-react';
